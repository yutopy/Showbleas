...
const routes: Routes = [
  ...
  {
    path: 'all-products-wafers-user',
    loadChildren: () => import('./pages/rol-user/all-products-wafers-user/all-products-wafers-user.module').then( m => m.AllProductsWafersUserPageModule)
  },
  {
