...
export class SignUpPage implements OnInit {
  ...
  doSignUp(){
    let postData = {
      ...
      "favorite_flavor":this.favorite_flavor,
    ...
    this.http.post('http://127.0.0.1:8000/api/auth/signup', postData, {headers: this.headers})
    .subscribe(data =>{
      // console.log(data);
      this.respuesta = data;
      ...
      if(this.respuesta['email']){
        ...
        this.http.post('http://127.0.0.1:8000/api/auth/login', loginData, {headers: this.headers})
        .subscribe(data => {
          // console.log(data)
          this.respuesta=data;
